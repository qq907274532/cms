...
class Page{
    ...
    public function show() {
        ...
        $header='';
        if($this->lastSuffix){
            $header='<li><span style="background-color:#1abc9c;color:white">'.$this->config['header'].'</span></li>';
        }
        ...
        for($i = 1; $i <= $this->rollPage; $i++){
            ...
            if($page > 0 && $page != $this->nowPage){
                ...
                if($page > 0 && $this->totalPages != 1){
                    $link_page .= '<li><span class="current" style="background-color:#1abc9c;color:white">' . $page . '</span></li>';
                }
            }
        }
