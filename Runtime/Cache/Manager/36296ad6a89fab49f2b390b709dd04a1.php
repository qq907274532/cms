                    ...
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="active">友情链接</li>
                             <li class="pull-right"><a  href="<?php echo U('Link/add');?>" class="btn btn-info">添加链接</a></li>
                        </ul>
                        <!--breadcrumbs end -->
                                           ...
                                           <td><?php echo ($v["id"]); ?></td>
                                            ...
                                            <td>
                                                <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                                    ...
                                                    <a href="<?php echo U('Link/edit',array('id'=>$v['id']));?>" >
                                                        <i class="fa fa-pencil"></i>
                                                    </a>

                                                    <a onclick="if(confirm('确认删除?')) location.href='<?php echo U('Link/del',array('id'=>$v[id]));?>'"  href="javascript:;" >
