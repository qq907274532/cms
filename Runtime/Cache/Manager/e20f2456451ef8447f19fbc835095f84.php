                                    ...
                                    <div class="col-sm-2" style="margin-left: -31px;">
                                         ...
                                         <select class="form-control" style="min-height: 30px;" name="group_id" id="role">
                                            <option value="0">请选择管理员</option>
                                             <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v["id"]); ?>"<?php if( $v["id"] == $_GET['group_id'] ): ?>selected=selected<?php endif; ?>><?php echo ($v["username"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                        </select>
                                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">操作日志管理</h3>
                                     ...
                                     <?php if(is_array($data["list"])): $i = 0; $__LIST__ = $data["list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <td>
                                                <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                                    ...
                                                    <a onclick="if(confirm('确认删除?')) location.href='<?php echo U('Log/del',array('id'=>$v[id]));?>'"  href="javascript:;" >
