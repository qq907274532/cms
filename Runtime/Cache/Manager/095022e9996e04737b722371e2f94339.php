...
<body>
                    ...
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="active">添加链接</li>
                             <li class="pull-right"><a  href="<?php echo U('Link/index');?>" class="btn btn-info">返回列表</a></li>
                        </ul>
                        <!--breadcrumbs end -->
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <form class="form-horizontal form-border"  method="post" action="" enctype ="multipart/form-data"  onsubmit="return check() ">
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label"> 公司名称： </label>
                                         <div class="col-sm-4">
                                            <input type="text" class="form-control" name="name" id="title" placeholder="公司名称" value="">
                                        </div>
   ...
   <script src="/Public/plugins/validation/js/jquery.validate.min.js"></script>
