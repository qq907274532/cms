                ...
                <div style="height:24px;margin-top: -14px;" class="page-header">
                        <form action="" method="get">
                            ...
                            <span class="input-icon input-icon-right">
                                <input style="text-indent:0.5em" type="text" id="name" placeholder="用户名" name="name" value="<?php echo ($_GET['name']); ?>">
                                </span>
                                <span class="input-icon input-icon-right">
                                <input style="text-indent:0.5em" type="text" id="email" placeholder="邮箱" name="email" value="<?php echo ($_GET['email']); ?>">
                                </span> 
                            <span class="input-icon input-icon-right">
                                <input style="text-indent:0.5em" type="text" id="starTime" placeholder="开始时间" name="starTime" value="<?php echo ($_GET['starTime']); ?>">
                                </span>
                                <span class="input-icon input-icon-right">
                                <input style="text-indent:0.5em" type="text" id="endTime" placeholder="结束时间" name="endTime"  value="<?php echo ($_GET['endTime']); ?>">
                                </span>
                                ...
                                <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                     <?php if(is_array($data["list"])): $i = 0; $__LIST__ = $data["list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                                                ...
                                                <td width="50">
                                                    <?php if($v["avatar"] == ''): ?><img style="width:30px;height:30px;"src="/Public/assets/img/1399.png">
                                                    <?php else: ?>
                                                    <img style="width:30px;height:30px;" src="<?php echo ($v["avatar"]); ?>"><?php endif; ?>
                                                </td>
                                                ...
                                                <td class="hidden-480">
                                                    <?php if($v["user_status"] == 0): ?><span class="label label-danger arrowed">禁用</span>
                                                    <?php elseif($v["user_status"] == 1 ): ?>
                                                    <span class="label label-success arrowed">正常</span>
                                                    <?php else: ?>
                                                    <span class="label label-info arrowed">未验证</span><?php endif; ?>
                                                </td>
                                                <td>
