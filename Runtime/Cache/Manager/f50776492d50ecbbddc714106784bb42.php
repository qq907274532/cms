                            ...
                            <div class="panel-body">
                                ...
                                <form class="form-horizontal form-border"  method="post" action="" onsubmit="return check()">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" name="title" id="title"  placeholder="角色名称" value="<?php echo ($info["title"]); ?>">
                                        </div>
                                    </div>
                                   <div class="form-group">
                                   ...
                                   <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <label class="radio-inline">
                                                <div class="iradio_flat-grey " style="position: relative;"><input class="icheck" type="radio" <?php if($info["status"] == '1'): ?>checked=checked<?php endif; ?> name="status"  value="1"></div>&nbsp;开启
                                                </label>
                                            <label class="radio-inline">
                                                <div class="iradio_flat-grey" style="position: relative;"><input class="icheck" <?php if($info["status"] == '0'): ?>checked=checked<?php endif; ?>  type="radio" name="status" value="0"></div>&nbsp;禁用</label>
