                    ...
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="active">管理员列表</li>
                             <li class="pull-right"><a  href="<?php echo U('Admin/add');?>" class="btn btn-info">添加管理员</a></li>
                        </ul>
                        <!--breadcrumbs end -->
                                           ...
                                           <?php if($v["logintime"] == ''): else: ?>
                                            ...
                                            <td>
                                                <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                                    ...
                                                    <a href="<?php echo U('Admin/edit',array('id'=>$v['id']));?>" >
                                                        <i class="fa fa-pencil"></i>
                                                    </a>

                                                    <a onclick="if(confirm('确认删除?')) location.href='<?php echo U('Admin/del',array('id'=>$v[id]));?>'"  href="javascript:;" >
